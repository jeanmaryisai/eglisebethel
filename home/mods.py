...
class heroSingle(models.Model):
    ...
    submenu1= models.CharField(max_length=255)
...
class firstSection(models.Model):
    ...
    submain= models.CharField(max_length=255,default="Nous rependons la parole de Dieu qu'importe ou nous allons et nous agissons selon les prescriptions laisser par Jesus Christ")
    show= models.BooleanField(default= True)
...
class statSection(models.Model):
    text=models.CharField(max_length=255,default="Notres statistique durants les deux dernier annees")
...
class serviceSingle(models.Model):
    ...
    description_bref=models.CharField(max_length=255)
...
class Service(models.Model):
    ...
    submenu=models.CharField(max_length=255,default="Nos horraires nous permettent de vous offrir une large evantaille de possibilitee pour vous de nous assister")    
    show=models.BooleanField(default=True)
    def __str__ (self):
        return self.title
...
class Sermons_main_section(models.Model):
    ...
    submenu=models.CharField(max_length=255,default="Profitez de nos Sermons")
    show=models.BooleanField(default=True)
...
class verset(models.Model):
    ...
    verset= models.CharField(max_length=255)
    def __str__ (self):
        return self.ref
...
class secteur(models.Model):
    ...
    description= models.CharField(max_length=255,null=True,blank=True,unique=True,default= 'this is the default populated description')
...
class evenement(models.Model):
    ...
    fulldescription=models.CharField(max_length=255,null=True)
...
class contact_page(models.Model):
    ...
    subtile_hero= models.CharField(max_length=255,default="Laissez nous un message, vos demande de prieres.")
    title=models.CharField(max_length=30, default='Contactez Nous')
    subtile= models.CharField(max_length=255,default="Qu'importe ou vous est dans le monde, la puissance du Seigneur reste et demeur le meme")
...
class about_page(models.Model):
    ...
    subtile_hero= models.CharField(max_length=255,default="Nous somme une eglise protestante situe en Haiti")
    show=models.BooleanField(default=True)
    def save(self, *args, **kwargs):
        if self.show== True:
            self.show= False
...
class bay(models.Model):
    ...
    subtitle_hero= models.CharField(max_length=255,null=True)
    show=models.BooleanField(default=True)
    ...
    intro_subtitle=models.CharField(max_length=255,null=True)
    verse_title=models.CharField(max_length=255,null=True)
    verse_text=models.CharField(max_length=255,null=True)
    fundraiser_title=models.CharField(max_length=255,null=True)
    fundRaiser_subtitle=models.CharField(max_length=255,null=True)
    fundraiser_button=models.CharField(max_length=50, null=True)
    give_title=models.CharField(max_length=255,null=True)
    give_subtitle=models.CharField(max_length=50, null=True)
    give_text=models.CharField(max_length=255,null=True)
...
class paragraph(models.Model):
    ...
    sous_titre=models.CharField(max_length=255,null=True,blank=True)
